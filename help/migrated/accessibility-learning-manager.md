...
1. コンテンツの種類に応じて表示されるコントロールを以下に示します。
...
* Learning Managerは、ビデオコンテンツ用のクローズドキャプションWebVTTファイルをアップロードする機能をサポートしています。 詳しくは、「  [*クローズドキャプションのWebVTTファイルのアップロード*](/help/migrated/authors/feature-summary/content-library.md).
