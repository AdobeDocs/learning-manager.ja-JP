...
詳細については[「Microsoft Teams 向け Adobe Learning Manager アプリ」](/help/migrated/adobe-learning-manager-app-microsoft-teams.md)を参照してください。
...
Google Play ストアや Apple App Store からモバイル版をダウンロードしてください。 アプリの古いバージョンのユーザーには、新しいアプリをダウンロードしてインストールするように求められます。
...
登録時に学習者のセッションが競合している場合、概要ページにポップアップが表示されます。 カタログページまたは概要ページから登録した際に学習者のセッションが競合していると、競合のポップアップがトリガーされます。ポップアップには、競合するセッションの詳細が含まれています。 学習者がセッションに競合がある場合でも、新しいセッションに登録できます。
...
![スイッチインスタンスの選択](assets/switch-instances-select.png)
_インスタンスプロンプトの切り替え_
...
詳細については[「インストラクター稼働率レポート」](/help/migrated/administrators/feature-summary/reports.md#instructor-utilization-report)を参照してください。
...
詳細については、[「アナウンス」](/help/migrated/administrators/feature-summary/announcements.md#as-email)を参照してください。
...
| 都市の検索とフィルタリング | filter.cityName=city_name<br>都市のコンマ区切りのリストもサポートします | GET /primeapi/v2/search |
...
Learning Manager web アプリとデバイスアプリの現在および以前のリリースについて詳しくは、[リリースノート](/help/migrated/release-note/release-notes.md)を参照してください。
