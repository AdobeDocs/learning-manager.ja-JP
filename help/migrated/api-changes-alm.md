...
- _プログラムの進捗状況ダッシュボード_ – パス&#x200B;_直接_&#x200B;を完了した学習者と、代替手段を使用してパスを満たした学習者を区別することで、より正確な進捗状況と修復のビューを表示します。
- _監査証跡_ - isAlternateComplete=trueとマークされたLOの場合、監査担当者は、その完了を付与するために使用された代替トレーニングを正確に確認できます。

この2つのフィールドが組み込まれていないと、下流のレポートで代替完了が通常の完了として扱われ、学習者が直接受講したことのないトレーニングを完了済みとして表示する&#x200B;_*&#x200B;理由&#x200B;*を_&#x200B;説明できなくなります。
