...
「**クイズ**」を選択して、クイズの動作と採点方法を設定します。

このタブには2つのセクションがあります： **全般**&#x200B;と&#x200B;**スコア付け**。
...
LMSにクイズ結果を報告するのに使用するSCORMバージョンを選択します。 LMSの互換性要件に一致するバージョンを選択します。
例えば、**SCORM 1.2**&#x200B;を選択します。

>[!NOTE]
>
>選択するSCORMバージョンが不明な場合は、LMS管理者に確認してください。
