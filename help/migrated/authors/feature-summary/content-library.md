...
5. 「**フォルダーに追加**」で、「**フォルダーを参照**」を選択し、コンテンツを保存するフォルダーに移動します。確認するフォルダーを選択します。
   ![](assets/cl3.png)
...
**コンテンツライブラリ**&#x200B;では、各コンテンツファイルのフォルダーのパス全体が表示されます。たとえば、**セールストレーニング** > **自習型モジュール** > **PDFアセット**&#x200B;などです。 このパスは、階層内でのファイルの保存場所を正確に示します。
...
コンテンツを移動すると、現在のフォルダーからコンテンツが削除され、移動先のフォルダーに配置されます。
...
>[!NOTE]
>
>プライベートフォルダからパブリックフォルダにコンテンツを移動したり、パブリックフォルダからプライベートフォルダにコンテンツを移動することはできません。
