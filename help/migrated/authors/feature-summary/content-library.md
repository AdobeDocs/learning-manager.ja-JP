...
* 多言語移動:キャプションを英語以外の対応する10の言語のいずれかに翻訳します。
...
5. 翻訳の追加のターゲット言語を選択します（最大10言語をサポート）。
...
* **対応言語：**&#x200B;英語以外の10言語（フランス語、ドイツ語、スペイン語、イタリア語、ポルトガル語、オランダ語、スウェーデン語、インドネシア語、ノルウェー語ブークモール、デンマーク語）がAdobe Learning Managerでサポートされています。
