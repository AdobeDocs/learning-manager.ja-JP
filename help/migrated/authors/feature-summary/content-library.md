...
**作成者** ALMにコンテンツを追加できます。 ALMには、次の2種類のコンテンツがあります。 **[!UICONTROL 内容]** および **[!UICONTROL クイズ]**. コンテンツを追加する方法については、以下を参照してください [静的コンテンツの追加](content-library.md#addstaticcontent) および [クイズの作成](content-library.md##createaquiz).

## 静的コンテンツの追加 {#addstaticcontent}

1. 選択 **[!UICONTROL コンテンツライブラリ]** としてログインした後、左側のペインで **作成者** を選択します **[!UICONTROL 追加]**.
...
1. Learning Manager は、Learning Manager でアップロードされたビデオコンテンツのキャプションをサポートします。 作成者は、ビデオファイルと一緒に、キャプションを含むファイルをアップロードできます。
   ...
   ビデオコンテンツをライブラリに追加する際には、VTTファイルを追加することもできます。この場合、以下の処理が実行されます **が** 有効なファイルを指定してください。
...
1. 様々な言語のクイズを追加するには、 **新しい言語を追加** タブをクリックして、必要な言語を選択します。 この方法を使用すると、コンテンツで複数の言語を使用できます。
...
1. 言語を削除するには、 **[!UICONTROL 新しい言語を追加]** タブをクリックして、選択を解除します。
   ...
   変更が完了したら、 **[!UICONTROL 保存]**. ライブラリで新しいコンテンツを使用できるようになります。

クイズが「 **[!UICONTROL コンテンツライブラリ]**. コンテンツライブラリのコンテンツと同様に、クイズは廃止してから削除できます。
...
>[!NOTE]
>
>また、次からコンテンツを追加することもできます。 **[!UICONTROL 退職]** セクション、次に移動 **[!UICONTROL コンテンツライブラリ]** > **[!UICONTROL 退職]** を選択します **[!UICONTROL コンテンツを追加]**. 詳しくは、「 [静的コンテンツの追加](content-library.md#addstaticcontent).
