...
6. 「[!UICONTROL 保存]」を選択します。 システムはVTTファイルの生成と変換を開始します。
...
5. [**フォルダーに追加**]で、フォルダーを参照するか、検索フィールドでフォルダーを検索します。
   ![](assets/cl3.png)
...
>[!NOTE]
>
>パブリックフォルダーとプライベートフォルダー間でコンテンツをコピーまたは移動することはできません。 これを行うと、Adobe Learning Managerでエラーが表示されます。
...
4. 一度に最大&#x200B;**25個のフォルダー**&#x200B;を選択できます。 25を超える数を選択すると、エラーが表示されます。
...
アップロードしたコンテンツが**[!UICONTROL コンテンツライブラリ]**&#x200B;に表示されます。
