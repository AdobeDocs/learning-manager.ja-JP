...
5. **以下の手順で、コースの設定を変更します**。
   ...
   a. 「コース設定」ページで、コースのスキルを選択します。スキルドロップダウンリストで、必要なスキルを選択します。次に、「レベル」ドロップダウンリストから必要なレベルを選択します。
   b.コースのスキル、レベルを選択し、スキルの単位を設定します。必要に応じて、さらにスキルを追加します。
...
7. 「**[!UICONTROL インストラクターに成功のマークを許可]**」オプションを選択します。
   ...
   ![[成功とマークすることをインストラクターに許可しますか？]チェックボックスが強調表示され、作成者はインストラクターにモジュールの学習者の成功ステータスを記録させることができます](/help/migrated/authors/feature-summary/assets/allow-instructor-mark-success.png)
