...
1. **通知アラート**&#x200B;ボックスを選択します。
2. カレンダーで、最初のリマインダーとしてコースの開始日より前の日付を選択します。
3. 右側の「**リマインダーを追加**」を選択します。
4. **電子メールテンプレート:**&#x200B;ドロップダウン**リストからテンプレートを選択します
5. **定期的なアイテム：**ドロップダウンリストから定期的なアイテムの種類を選択します。
右側の青いチェックマークを選択して、リマインダー日付を保存します。 リマインダーの日付は個別に保存する必要があることに注意してください。
