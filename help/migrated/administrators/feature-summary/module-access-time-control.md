...
**評価または試験の環境**：組織は短い明確な期間にモジュール（テストなど）を開くことができます（例： 「指定された日の9:00 ～ 12:00の間にいつでも試験を開始できます」）。 学習者は、この時間枠外に試験を開始することはできません。この時間帯は、タイムゾーンとグループを越えた公正なスケジューリングをサポートします。
