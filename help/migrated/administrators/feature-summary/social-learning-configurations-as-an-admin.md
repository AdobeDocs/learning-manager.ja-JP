...
AdobeのLearning Managerデスクトップアプリケーションを使用してコンテンツを投稿することもできます。 Mac と Windows のどちらを使用しているかに応じて、該当するリンクをクリックしてデスクトップアプリケーションをダウンロードし、画面に表示される手順に従ってアプリケーションをコンピューターにインストールしてください。インストールできない場合は、[ここをクリック](../../kb/troubleshooting-issues-with-adobe-learning-manager-desktop-app.md)してください。
