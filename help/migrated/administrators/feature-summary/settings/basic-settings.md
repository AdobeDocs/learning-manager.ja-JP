...
2. **リマインダーのスケジュールを定義する**：表示される&#x200B;**リマインダーの設定**&#x200B;パネルで、ドロップダウンメニューと入力フィールドを使用して、リマインダーを設定します。
   ...
   b. **[!UICONTROL 繰り返し]**：リマインダーの頻度を選択します（例：毎週）。
...
a. **[!UICONTROL 送信のタイミング]**:リマインダーが送信されるタイミングを選択します。オプションは、**[!UICONTROL コースの完了時]**&#x200B;および&#x200B;**[!UICONTROL コースの完了後]**&#x200B;です。
b. **[!UICONTROL 繰り返し]**:リマインダーの頻度を選択します。繰り返しが&#x200B;**[!UICONTROL 1回]**&#x200B;の場合、マネージャーはフィードバックを提供する通知を1回受け取ります。利用可能なオプションは、「1回」、「毎日」、「毎週」、「毎月」です。
...
ii.コースの完了や資料の閲覧などのアクションを引き続き実行できます。
b.未登録の学習者：
i.コースまたは学習パスを廃止前に登録していなかった学習者には、カタログにコンテンツが表示されなくなります。
ii.廃止されたコンテンツに完全にアクセスできなくなります。
2. 撤回すると、登録済みの学習者と未登録の学習者の両方がアクセスできなくなります。
a.登録済み学習者：
i.コースまたは学習パスに既に登録されていた学習者は、コンテンツを廃止するとアクセスできなくなります。
ii.廃止されたコンテンツを表示したり、アクションを実行したりできなくなります。
b.未登録の学習者：
i.コンテンツはカタログに表示されなくなるため、コースや学習パスに登録していない学習者もアクセスできなくなります。
