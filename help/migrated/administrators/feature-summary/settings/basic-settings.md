...
作成者がコースごとに成績表を表示または非表示にできるアカウントレベルの権限をアクティブにします。 有効にすると、作成者にはコースエディターに「学習者に成績表を表示」オプションが表示されます。 作成者が成績表を有効にしたコースについては、コースプレーヤーに「成績表」タブが表示されます。 アカウントレベルでこの設定を無効にすると、すべてのコースレベルの設定が上書きされます。 設定を再度有効にするまで、学習者はどのコースにも成績表を表示できません。
