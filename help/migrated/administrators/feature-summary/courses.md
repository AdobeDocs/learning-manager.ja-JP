...
管理者は、デフォルトのバッジ、ゲーミフィケーション設定およびリマインダーを **[!UICONTROL 既定のインスタンス]** ページです。 デフォルトのインスタンス設定を変更するには、 **[!UICONTROL 既定のインスタンス]** > **[!UICONTROL 編集]**.

* **[!UICONTROL バッジ]**：ドロップダウンメニューからデフォルトのバッジを選択します。
* **[!UICONTROL ゲーミフィケーション]**：完了、早期完了、およびタイムリーな完了のためのポイントを含む、ゲーミフィケーションの設定を構成します。 管理者は、アカウントレベルの設定を選択するか、このインスタンスのゲーミフィケーションポイントをカスタマイズすることができます。
* **[!UICONTROL L1反応フィードバック]**：コースの完了時に学習者のフィードバックに対して事前定義された質問を有効にします。また、質問を必須にするオプションを備えています。
***[!UICONTROL L3行動変化フィードバック]**：コースの完了時に、学習者のマネージャーに対してフィードバックの質問を有効にします。
***[!UICONTROL リマインダー設定]**：期限に関するリマインダーを設定および管理し、エスカレーションのオプションを設定します。
