...
>[!NOTE]
>
>この機能（**L1フィードバックレポート**）は、FedRAMPが承認している環境では使用できません。 詳細については、[FedRAMP環境での機能の可用性](/help/migrated/feature-availability-in-fedramp-authorized-environment.md)を参照してください。
...
6. **[!UICONTROL 質問を追加]**&#x200B;メニューから、次の質問の種類を選択します。
   ...
   a. **[!UICONTROL フリーテキスト]** ：学習者が自分の言葉で答えられるようにします。
   ...
   * 質問を必須にするには、**[!UICONTROL 必須]**の切り替えを選択します。
   ...
   c. **[!UICONTROL Likertスケール]** ：学習者は、強く同意しない人から強く同意する人まで、ステートメントに同意する度合いを指定できます。
