...
>[!INFO]
>
>Adobe Learning Managerでのシングルユーザーの追加について詳しくは、このALMアカデミーのトレーニングをご覧ください。<br>[![ボタン](assets/launch-training-button.png)](https://content.adobelearningmanageracademy.com/app/learner?accountId=98632#/course/7555534)</br>
...
6. 「**追加**」を選択します。ユーザーは、アクセス用のログインURLを含む案内メールを受け取ります。
...
管理者は、ユーザーデータを包括的なレポートとして書き出したり、ダウンロードしたりできます。 このデータを書き出すことで、管理者は、学習者のアクティビティの追跡、アカウントのライフサイクルの監視、使用頻度の低いユーザーの特定、コンプライアンス、監査、レポート作成に役立つ正確な記録の維持を実行できます。

ユーザーレポートをダウンロードするには：

1. Adobe Learning Managerに管理者としてログインします。
2. **ユーザー**&#x200B;を選択して、**内部**&#x200B;を選択します。
3. **ユーザーデータのエクスポート**&#x200B;を選択します。 レポートの準備ができたら通知されます。

   ![](assets/select-export-user-data.png)
   _内部ユーザーセクションには、ユーザーレポートをエクスポートおよびダウンロードするオプションが表示されます。_
4. 通知を選択し、ユーザーレポートをダウンロードします。
...
| ゲーミフィケーションが使用できます。 | ゲーミフィケーションが使用できます。 管理者は、[ゲーミフィケーション設定](https://experienceleague.adobe.com/ja/docs/learning-manager/using/admin/gamification)で社外学習者のゲーミフィケーションを有効にする必要があります。 |
...
管理者は、ある社外プロファイルから別のプロファイルに学習者を再割り当てすることができます。

社外プロファイルを変更するには、次の手順を実行します。

1. Adobe Learning Managerに管理者としてログインします。
2. **[!UICONTROL ユーザー]**&#x200B;を選択し、**[!UICONTROL 外部]**&#x200B;を選択します。
3. 外部プロファイルのリストで&#x200B;**[!UICONTROL 使用されている席]**&#x200B;を選択します。

   ![](assets/select-learners-external-profile.png)
   _使用されているシート数を示す外部プロファイルセクション_

4. 学習者を選択して、**[!UICONTROL アクション]**&#x200B;を選択します。

   ![](assets/select-change-profile-external-learner.png)
   _学習者を別のプロファイルに移動するための「プロファイルの変更」オプションをハイライトした外部プロファイルページ_

5. **[!UICONTROL プロファイルの変更]**&#x200B;を選択します。
6. 別の社外プロファイルを検索して選択します。

   ![](assets/search-and-select-profile.png)
   _プロファイルの変更を求めるメッセージには、外部プロファイルを検索するためのオプションが表示されます_

選択した学習者は、選択した社外プロファイルに移動します。
...
>[!INFO]
>
>役割の割り当てと削除、案内メールの送信、ユーザーの削除と消去の方法については、このALMアカデミーのトレーニングをご覧ください。<br>[![ボタン]](https://content.adobelearningmanageracademy.com/app/learner?accountId=98632#/course/7555586)</br>
