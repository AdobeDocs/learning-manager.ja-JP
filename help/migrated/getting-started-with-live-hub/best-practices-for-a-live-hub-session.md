...
# ライブハブセッションのベストプラクティス

Adobe Learning Managerのライブハブコースでは、インストラクターと学習者が一緒になってリアルタイムのトレーニングを受けることができ、チャット、投票、クイズ、ホワイトボード、ブレイクアウトルーム、レコーディング、分析などを利用できます。 この記事では、各タスクの実行方法について説明します。 この文書はその仲間で、それをうまく行う方法を説明しています。
