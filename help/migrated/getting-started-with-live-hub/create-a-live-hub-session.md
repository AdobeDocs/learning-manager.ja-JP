...
1. 次のいずれかのオプションを使用して、インストラクターを追加します。
   ...
   1. 「**AIを使用したインストラクターの検索**」を選択して、AI推奨のインストラクターを表示します。 詳しくは、「[インストラクターファインダーを使用したインストラクターの追加](#add-instructors-using-instructor-finder)」を参照してください。
...
1. 「**インストラクター**」フィールドに、名前を手動で入力するか、**AIを使用してインストラクターを検索**&#x200B;して、AIが推奨するインストラクターを指定します。 詳しくは、「[インストラクターファインダーを使用したインストラクターの追加](#add-instructors-using-instructor-finder)」を参照してください。
