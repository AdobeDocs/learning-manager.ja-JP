...
を選択すると、コンピテンシーに基づいて検索できます **コンピテンシー** そしてそれを選んだ マネージャーは、4つの方法でコースを並べ替えて、必要なコースを見つけやすくすることができます。 「並べ替え条件」をクリックして、アルファベット昇順、アルファベット降順、コース更新日、コース作成日、コースの有効性を選択します。
