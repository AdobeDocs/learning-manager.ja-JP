...
マネージャーとして、利用可能なすべてのコースのリストを表示することができます。 左ペインで&#x200B;**[!UICONTROL 「コース」]**&#x200B;をクリックすると、検索と絞り込みのオプションがあるコースのリストが表示されます。 また、各コースの有効性を示すパーセンテージが、コースのサムネイルに表示されます。 注意：学習者アプリケーションで表示されるコースにのみチームメンバーを登録することができます。
...
>[!NOTE]
>
>「**撤回済み**」タブをクリックすると、廃止されたすべてのコースが一覧表示されます。
...
マネージャーは、コースモジュールを表示しながら「**学習者としてプレビュー**」オプションをクリックして、コースをプレビューできます。
...
1. 検索フィールドを使用します。 右上隅に表示されている検索アイコンをクリックします。 検索フィールドが表示されます。 コース名またはコースに関連付けられているキーワードを入力して、コース/学習パスを検索します。 また、Captivate、C、Java および HTML などの定義済みのタグを使用して検索することもできます。 タグは検索フィールド内で検索可能です。つまり、入力と同時にタグが検索フィールドに表示されます。 一意の ID を使用して検索を実行することもできます。
1. フィルターを使用して、コース/学習パス/資格認定のリストをフィルタリングします。 「すべて」、「公開済み」、「撤回済み」などの状態でコースをフィルタリングできます。

**「コンピテンシー」**&#x200B;を選択して選択すると、コンピテンシーに基づいて検索できます。 マネージャーは 4 つの方法でコースを分類し、必要なコースをより正確に見つけることができます。 「並べ替え条件」をクリックして、アルファベット昇順、アルファベット降順、コース更新日、コース作成日、コースの有効性を選択します。
...
1. マネージャーモードで、左ペインの「学習パス」をクリックします。
...
1. マネージャーとしてログインした後、左ペインの認定をクリックします。 公開済みタブのリストから、各認定にマウスを合わせ、「学習者を登録」をクリックします。 または、公開されている認定タイルをクリックし、左ペインの「学習者」をクリックします。 学習者ページの右側にある「+登録」をクリックして、学習者の追加を開始します。
1. 上記の 2 つの手順のそれぞれから学習者を登録するオプションをクリックした後、学習者の登録ポップアップダイアログを表示することができます。 学習者の名前とプロファイルを入力し、ドロップダウンリストから学習者の名前を選択し、「保存」をクリックします。
...
学習者の登録を承認または拒否しようとするとき、マネージャーは、セッション（**ビデオ会議**、**教室**）の詳細をポップアップウィンドウで確認できるようになりました。
...
1. 学習者がコースの承認をリクエストするとマネージャーに通知が表示されます。
...
1. 学習者は、コース登録に対する承認または拒否の通知を受け取ります。
