...
1. **[!UICONTROL ツール]**/**[!UICONTROL Cloud Service]**/**[!UICONTROL CaptivateのLearning Managerウィジェット設定]**&#x200B;をクリックします。
...
**[!UICONTROL 上位のLO登録を無視]**&#x200B;チェックボックスがオンであり、ユーザーが学習プログラムまたは資格認定に直接登録されている場合、その資格認定または学習プログラムに関するコースがウィジェットでユーザーに表示されます。
