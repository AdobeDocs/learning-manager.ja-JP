...
管理者は、場所、役割、製品、その他の条件に基づいて、様々な学習者グループに合わせたGo1コースのプレイリストを作成できます。 プレイリストは、手動で作成するか、AIを使用して生成することができます。

再生リストを作成するには：

1. Adobe Learning Managerに管理者としてログインします。
2. 左側のナビゲーションウィンドウで[**[!UICONTROL コンテンツマーケットプレイス]**]を選択します。

   ![](assets/select-content-marketplace.png)
   _Adobe Learning Managerで「コンテンツマーケットプレイス」を選択して、Go1コースの上位を検索し、プレイリストに追加してください_

3. **[!UICONTROL コンテンツハブ]**&#x200B;を選択し、**[!UICONTROL ライブラリ]**&#x200B;を選択します。
4. **[!UICONTROL 再生リストの作成]**&#x200B;を選択し、次のいずれかを選択します：
a. **[!UICONTROL AIを活用]**:AIを活用したプレイリストを作成します。
b. **[!UICONTROL 自分で]**：再生リストにコースを手動で追加して、再生リストを作成します。

   ![](assets/select-create-playlist.png)
   _Adobe Learning Managerで「再生リストを作成」を選択して新しい再生リストを作成し、学習者を対象としたコースを整理して配信します_

**AIで再生リストを作成する**

管理者は、AIプロンプトで再生リストの説明を入力できます。 AIが関連コースをキュレートし、要件に基づいてプレイリストを作成します。
...
4. リストからスキルを選択し、プレイリストのコース期間とタイプを選択します。
5. **[!UICONTROL 再生リストの生成]**&#x200B;を選択します。

   ![](assets/select-generate-playlist.png)
   _Adobe Learning Managerでプレイリストをカスタマイズするには、関連するスキルとコースの期間を選択します_


再生リストには10のコースが作成されており、管理者はこのコースを使用して学習パスを作成できます。

![](assets/created-playlist.png)
_Adobe Learning Managerで、厳選されたセールスエンジニアのスキル向上プレイリストを確認してください_
...
6. **[!UICONTROL ライブラリ]**&#x200B;で、**[!UICONTROL Go1コースの選択画面]**&#x200B;で再生リストを検索して選択します。

   >[!NOTE]
   >
   >再生リストを簡単に見つけるには、「自分が作成」フィルターを必ず設定してください。

   ![](assets/select-save-to-add-playlist.png)
   _Adobe Learning ManagerのGo1コースライブラリからセールスエンジニアの再生リストを選択_

7. **[!UICONTROL [ライブラリに追加]]**&#x200B;を選択し、**[!UICONTROL [保存]]**&#x200B;を選択します。

   ![](assets/add-playlist-to-lp.png)
   _Adobe Learning ManagerのGo1ライブラリからセールスエンジニアのスキル向上プレイリストを選択して読み込みます_

8. 「**[!UICONTROL 追加]**」を選択し、「**[!UICONTROL Publish]**」を選択します。
...
同じ手順で、Illustratorなどの他の製品用のページを作成します。
