...
* **チェックリストモジュールの場合：**
列に評価コメント（チェックリストのレビュー担当者のコメント）が表示されます。
...
* この列には、上記の動作に合わせて、レビュー担当者のコメントが含まれます。
   * 提出モジュールの提出コメント
   * チェックリストモジュールの評価コメント
...
| コネクタに書き出されたLTを使用し、列名でマップします | 新しい列の校閲者のコメントが利用可能になります。 | オプション。 新しいレビュー担当者/チェックリストコメントデータを使用する場合を除き、変更は必要ありません。 |
