...
4. トランスクリプトまたはコースリストの表示でフィルターメニューを使用して、**ダイレクト**、**代替**、または **すべて** を選択します。
5. 選択した完了方法に基づいて、更新されたリストを確認します。

#### 管理者および作成者の場合

1. 管理者インターフェイスで、コースまたは学習パス間の同等の関係または代替関係を設定します。
2. 代替完了が LO カードおよび学習者*向けフィルターに正しく反映されていることを確認します。
3. 学習者のビューとレポートを使用して、UI と書き出されたデータの一貫性を確認します。
4. ソーストレーニングが廃止または削除された場合は、影響を受ける LO カードが適切に更新されることを検証します（例えば、該当する場合は **代替（失効）** と表示します）。

## 遡及完了および未完了動作

ALM では、遡及完了と遡及未完了がサポートされているため、学習者がトレーニングを完了した後に関係が作成、変更または削除された場合でも、代替および同等の関係が時間の経過とともに正確に維持されます。

### 遡及完了

#### 定義

遡及的完了が有効になっていると、過去にソースコースを完了した学習者が、同等または代替の関係が後で作成された場合、自動的にターゲットコースの代替完了を受け取ります。\
これにより、学習者がトレーニングを再受講しなくても、過去の学習を確実に活用できます。

#### 動作の仕組み

1. 管理者は、アカウントレベルで遡及完了を有効にします。
2. 管理者は、ソーストレーニングとターゲットトレーニングの同等または代替の関係を定義します。
3. システムは、ソース研修の履歴完了レコードをスキャンします。
4. 対象となる学習者には、ターゲットトレーニングの代替完了が付与されます。
5. これらのレコードは、学習者のトランスクリプトおよびレポートで **代替を使用して完了** と表示されます。

### 遡及的未完了

#### 定義

遡及的未完了が有効化されている場合、基礎となる同等または代替関係が削除されたり、ソースのトレーニングが削除されたりすると、代替完了が取り消されます。\
これにより、現在の有効なトレーニング関係がシステムに反映されます。

#### 動作の仕組み

1. 管理者は、アカウントレベルで遡及的不完了を有効にします。
2. 管理者は、代替または同等の関係を削除するか、ソーストレーニングを削除します。
...
レポートでは、コンプライアンス、サポート調査、監査をサポートするために、直接完了、代替完了、失効した代替完了を明確に区別します。
...
5. 失効したレコードは、監査を表示するために **トランスクリプトおよびレポートで** 代替（失効））とマークされます。

#### 前提条件への影響

代替完了（遡及的に付与された完了を含む）は、前提条件を評価する際に有効な完了として扱われます。\
学習者が **代替トレーニングで完了** すると、ターゲットトレーニングを必要とするコースを続行できます。

代替完了が遡及的不完了によって後で取り消された場合、学習者は、その前提条件に依存するコースの資格を失う可能性があります。
