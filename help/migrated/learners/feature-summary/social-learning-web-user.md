...
同様に、Learning Manager のソーシャル学習機能により、ユーザー間でコンテンツを共有し、ユーザー同士で対話しながら学習できます。

このプラットフォームでは、ビデオ、音声、スクリーンショット、テキスト、質問、アンケートを共有することができます。 また、「**Social に共有**」ブックマークレットを使用して、ユーザー間でオンライン学習コンテンツを共有することもできます。 詳細については、[ソーシャル学習への共有](share-to-social.md)を参照してください。

**Adobe Learning Manager デスクトップアプリケーション**&#x200B;を使用して、掲示板にコンテンツを投稿することもできます。 詳細については、[デスクトップ用Adobe Learning Managerアプリ](../adobe-learning-manager-app-for-desktop.md)を参照してください。
...
1. 投稿するコンテンツのタイプとして、テキスト、質問、ビデオ、音声、投票、スクリーンショットのいずれかを選択します。 既存のコンテンツは、ユーザーのコンピューターからアップロードすることも、Adobe Learning Manager デスクトップアプリケーションのギャラリーからアップロードすることもできます。
   ...
   ビデオや画面の録画、音声の録音、スクリーンショットの撮影を実行する場合は、Adobe Learning Manager デスクトップアプリケーションを使用してください。 詳細については、[「Adobe Learning Manager デスクトップアプリケーション」](../adobe-learning-manager-app-for-desktop.md)を参照してください。

   <!--![](assets/types-of-post-03.png)-->

1. 作成する投稿に関連する掲示板またはスキルを検索します。 該当する掲示板が存在しない場合は、「**[!UICONTROL 新しい掲示板を作成]**」をクリックします。
...
1. ポップアップダイアログボックスが表示されたら、掲示板の詳細情報を入力し、以下に示すいずれかのタイプを選択します。
   ...
   * **制限付き** – 掲示板の所有者、管理者、および掲示板のモデレーターのみが投稿を作成できます。 ただし、その他のユーザーも、コメント、返信、高評価、低評価などを入力することにより、参加することができます。
   ...
   >
   >管理者、作成者、学習者、マネージャー、インストラクターなど以外のユーザーは、**ユーザーグループでプライベートボードを作成**&#x200B;できません。 プライベートボードの作成時に&#x200B;**ユーザーグループのセクションを表示できません**。
...
学習者は、リスト表示ですべての掲示板を表示できます。 学習者アプリにサインインして「ソーシャル学習」ページで、以下のボタンをクリックします。
...
コンテンツは、「投稿」、「コメント」または「返信」セクションからダウンロードできます。 一度にダウンロードできるファイルは 1 つだけです。

両方のタイプのユーザー（内部または外部）がコンテンツをダウンロードできるようにする必要があります。

「ダウンロード」ボタンは、投稿やコメント、返信の検索結果にも表示されます。
...
複数のユーザーグループが非公開掲示板に追加されると、追加されたグループのユーザー全員がその掲示板にアクセスすることができるようになります。
...
1. 投稿の右上隅に表示されている折りたたまれたメニューアイコンをクリックして、「**[!UICONTROL マイストーリーに追加]**」を選択します。
...
作成する投稿に関連した掲示板がない場合は、「[新しい掲示板を作成](social-learning-web-user.md#Creatingcontentasapost)」をクリックします。  掲示板の編集、削除、報告、URL のコピーを行うには、以下の手順を実行します。お気に入り掲示板リストに掲示版を追加する場合も、以下の手順を実行します。
