...
学習者ホームページで、次をクリックします。 **[!UICONTROL ゲーミフィケーション]** 左側のペインから実行します。 リーダーボードを表示するには、リーダーボードのリンクをクリックします。 この機能を使用することで、特定のチームメンバーとの対戦状況を把握することができます。 また、チーム内のメンバー間のランキングを把握することもできます。
