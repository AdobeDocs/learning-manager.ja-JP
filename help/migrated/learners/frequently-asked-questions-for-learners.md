...
「学習」タブでは、登録済みまたは自分に割り当てられているすべての[コース](feature-summary/courses.md)、[学習プログラム](feature-summary/learning-programs.md)および[資格認定](feature-summary/certifications.md)を表示できます。 「学習を開く」リンクをクリックすることで「学習」タブに移動することもできます。

「カタログ」タブには、企業アカウントの学習者の役割を持つ学習者が利用可能なすべてのコース、学習プログラム、資格認定が表示されます。 「カタログに移動」リンクをクリックすることで「カタログ」タブに移動することもできます。
...
+++スマートフォンから Learning Manager にアクセスできますか？
...
+++iPadで Learning Manager にアクセスできますか？
...
+++Learning Manager にログインできません。 どうしたらよいですか？
...
+++これまでの学習履歴や学習レポートはどこで確認することができますか？
...
タスクを完了したときには常にゲーミフィケーションポイントを取得します。 現在、Learning Manager には 6 つのゲーミフィケーションタスクがあります。 各タスクが完了すると、そのタスクに関連付けられている特定のポイントを取得します。 詳細については、[ゲーミフィケーション](feature-summary/gamification.md)機能を参照してください。
...
学習プログラムページの右上隅には「**プログラムの開始**」ボタンが表示されます。 「**[!UICONTROL プログラムの開始]**」をクリックしてコースの受講を開始します。

+++

+++ポイント（ゲーミフィケーションポイント）はどうすれば獲得できますか？
...
+++トレーニングコンテンツは全画面表示できますか？

Learning Manager のすべてのコースはブラウザーで再生されます。 Learning ManagerのFluidicプレーヤーを使用すると、全画面でコースを表示できます。
...
+++Learning Manager では、学習者にパーソナライズされたエクスペリエンスを提供していますか？
...
1. コースの下部にプレーヤー画面が表示されたら、+（メモ）アイコンをクリックしてメモセクションを開きます。
...
1. 「**[!UICONTROL メモのダウンロード]**」をクリックすると、PDF 形式でダウンロードされます。
1. 「**[!UICONTROL メモを電子メールで送信]**」をクリックすると、自分の電子メールアドレスにメモを送信できます。

+++

+++Learning Manager では自己報告型のトレーニングを追加できますか？ また、そのためにはどうすればよいですか？
...
+++学習履歴の順にコースリストを表示することはできますか？

現在、この機能は利用できません。

+++

+++コースの評価やフィードバックは、どうすれば提出できますか？
...
+++トレーニングトランスクリプトは、どうすれば表示して印刷できますか？

現在、Learning Manager 1.0 ではトレーニングトランスクリプトを利用できません。

+++

+++登録したコースは、どうすればキャンセルできますか？
...
+++マイコースについて、通知やリマインダーを受け取ることはできますか？
...
+++どうすれば Learning Manager のマイコースにアクセスできますか？
