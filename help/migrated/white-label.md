...
<table>
  ...
  <p>アプリアイコンをpngに変換します。 このアイコンはアプリに表示されます。 名前の形式はaccount-id_appIcon.pngです。 アプリアイコンのサイズは512 × 512ピクセルです。</p></td>
  ...
  <p>アプリのスプラッシュ画面には、ユーザーがアプリを起動したときに表示される画像(png)を指定します。 名前の形式はaccount-id_splashIcon.pngです。 正方形ベースのスプラッシュ画面の寸法は1052×1052ピクセルであり、円ベースのスプラッシュ画面は768 x 768ピクセルである。</p></td>
