...
- [Harvard ManageMentorコネクタのコースメタデータファイル](https://experienceleague.adobe.com/docs/learning-manager/assets/hmm12-metadata.csv?lang=en)
- [Harvard ManageMentorコネクタのユーザーフィードファイル](https://experienceleague.adobe.com/docs/learning-manager/assets/client-hmm12-20170304.csv?lang=en)
