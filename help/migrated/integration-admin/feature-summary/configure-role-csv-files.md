...
* サンプルファイル： [role.csv](assets/role.zip)
* サンプルファイル： [user_role.csv](assets/user-role.zip)
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>コース、カタログなど、各エンティティタイプのアクセスタイプ（完全、書き込み、登録、レポート、なし、など）を特定します。</p></td>
   <td>
    <p>完全</p>
    <p>なし</p>
    <p>書き込み | レポート</p>
...
CSV によって作成したカスタムの役割は、CSV を使用して完全に管理できます。 これには役割の追加、変更、削除が含まれます。
