...
学習者は、送信された拒否の通知内のインストラクターのコメントを確認できます。 その後、学習者は、コメントの形式で詳細情報を提出して、再提出できます。
...
1. インストラクターは、自分に割り当てられているアクティビティモジュールを選択します。 モジュールの「送信内容」ページで、インストラクターは&#x200B;**「編集」**&#x200B;をクリックします。 却下するコメントを入力し、「コメントを表示」オプションを有効にすると、学習者が通知でコメントを表示できるようになります。

   ![](assets/enter-comments.png)
   *完了時のコメントを入力する*

1. インストラクターは&#x200B;**「拒否」**&#x200B;をクリックすることができます。 送信の状態が&#x200B;**却下のマークが付けられた**&#x200B;に変わります。
...
1. 学習者には、自分の提出物が拒否されことを示す通知が表示されます。 インストラクターからのコメントも通知に表示されます。
...
Live Hubを使用して作成したセッションの場合、**セッションの概要**&#x200B;ページの&#x200B;**Live Hub**&#x200B;セクションを使用すると、主要なセッション活動にすばやくアクセスできます。

&#x200B;- **バーチャルクラスルームに入る**: **クラスルームに入る**&#x200B;を選択してバーチャルクラスルームに参加するか、セッション開始前に設定します。 「**URLをコピー**」を選択してセッションリンクをコピーし、参加者と共有することもできます。

&#x200B;- **セッション分析の表示**: **分析の表示**&#x200B;を選択して、セッションの終了後にセッション分析ダッシュボードを開きます。 ダッシュボードには、学習者の出席、参加、エンゲージメント、その他のセッション指標に関するインサイトが表示されます。

&#x200B;- **録画を表示**:セッションが録画された場合、**録画を表示**&#x200B;を選択して、**セッションの概要**&#x200B;ページから直接レコーディングにアクセスします。 記録できない場合は、カードにステータスが表示されます。

![セッションの概要ページ](../../getting-started-with-live-hub/assets/session-overview-page.png)
*ライブハブのアクティビティへのアクセス権を持つ「ライブハブ」セクションを表示している「セッションの概要」ページ。*